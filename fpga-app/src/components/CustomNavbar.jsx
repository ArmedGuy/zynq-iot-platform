    ...
    return (
      <div className="sidenav sidebar">
        ...
        <Nav>
          ...
          <NavItem eventKey={2} componentClass={Link} active={window.location.pathname === '/' || window.location.pathname === '/devices'} href="/" to="/"><i className="fas fa-cog"></i> <span>Devices</span></NavItem>
